  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
      <div className="min-h-screen flex flex-col">
        ...
        <section className="w-full px-4 sm:px-6 lg:px-8 py-8 border-b shadow-sm bg-gradient-to-b from-transparent to-muted/5">
          <div className="mx-auto w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
            ...
            <div className="w-full h-[280px] sm:h-[340px] md:h-[380px] rounded-lg border shadow-xl bg-gradient-to-br from-background to-muted/10 overflow-hidden">
